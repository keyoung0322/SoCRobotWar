...
void drawCross(U16 *buf, int x, int y, int length, int thick, int width, int height)
{
	int i, j;
	int index;
...
void draw_img_from_buffer_separator(U16* buf, const int DIR)
{
	DrawRaw_value draw_value;
	draw_value.imgbuf = buf;
	
	draw_value.InitDX  = draw_value.InitDY = 0;
	draw_value.EndX = 319, draw_value.EndY = 479;

	switch(DIR) {
	case LEFT_SCREEN:
		draw_value.InitSX = -4096, draw_value.InitSY = -9728;
		draw_value.dxSx = 319, draw_value.dxSy = 0;
		draw_value.dySx = 0, draw_value.dySy = 319;
		break;
	case RIGHT_SCREEN:
		draw_value.InitSX = -4096, draw_value.InitSY = -81920;
		draw_value.dxSx = 319, draw_value.dxSy = 0;
		draw_value.dySx = 0, draw_value.dySy = 319;
		break;
	case LEFT_TOP_SCREEN:
		draw_value.InitSX = -6144, draw_value.InitSY = 66048;
		draw_value.dxSx = 0, draw_value.dxSy = -426;
		draw_value.dySx = 426, draw_value.dySy = 0;
		break;
	case LEFT_BOTTOM_SCREEN:
		draw_value.InitSX = -6144, draw_value.InitSY = 132096;
		draw_value.dxSx = 0, draw_value.dxSy = -426;
		draw_value.dySx = 426, draw_value.dySy = 0;
		break;
	case RIGHT_TOP_SCREEN:
		draw_value.InitSX = -106496, draw_value.InitSY = 66048;
		draw_value.dxSx = 0, draw_value.dxSy = -426;
		draw_value.dySx = 426, draw_value.dySy = 0;
		break;
	case RIGHT_BOTTOM_SCREEN:
		draw_value.InitSX = -106496, draw_value.InitSY = 132096;
		draw_value.dxSx = 0, draw_value.dxSy = -426;
		draw_value.dySx = 426, draw_value.dySy = 0;
		break;
	case FULL_SCREEN:
		draw_value.InitSX = -2048, draw_value.InitSY = 62976;
		draw_value.dxSx = 0, draw_value.dxSy = -204;
		draw_value.dySx = 204, draw_value.dySy = 0;
		break;
	}
